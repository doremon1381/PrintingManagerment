...
namespace IssuerOfClaims.Models
{
        ...
        public readonly static IEnumerable<string> SupportedSigningAlgorithms = new List<string>
    {
        ...
        //    public static readonly string Stores = IssuerOfClaims.Tracing.TraceNames.Store;
        //    public static readonly string Cache = IssuerOfClaims.Tracing.TraceNames.Cache;
        //    public static readonly string Validation = IssuerOfClaims.Tracing.TraceNames.Validation;
        //    public static readonly string Services = IssuerOfClaims.Tracing.TraceNames.Services;
